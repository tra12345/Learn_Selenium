...
public class TC_Class1 {
    ...
    final String userName_element = "//input[@name='uid']", password_element = "//input[@name='password']", signIn_element = "//input[@name='btnLogin']";
    ...
    public void tc01LaunchURL() {
        System.setProperty("webdriver.chrome.driver",set);
